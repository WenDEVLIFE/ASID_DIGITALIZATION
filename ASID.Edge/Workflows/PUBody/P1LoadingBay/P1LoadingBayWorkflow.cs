...
namespace ASID.Edge.Workflows.PUBody.P1LoadingBay
{
    public class P1LoadingBayWorkflow : IWorkflow
    {
        private readonly P1LoadingBayContext _context = new();
        public P1LoadingBayContext Context => _context;
        public WorkflowState CurrentState => _context.State;
        private readonly P1LoadingBayValidationService _validation = new();
        ...
        public WorkflowMessage CurrentMessage
        {
            get
            {
                return _context.State switch
                {
                    ...
                    {
                        Title = "SUCCESS",
                        Message = "P1 Loading Bay transaction completed successfully.",
