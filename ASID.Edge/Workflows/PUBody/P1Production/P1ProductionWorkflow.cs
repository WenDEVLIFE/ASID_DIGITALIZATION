...
{
    public class P1ProductionWorkflow : IWorkflow
    {
        private readonly P1ProductionContext _context = new();
        public P1ProductionContext Context => _context;
        public WorkflowState CurrentState => _context.State;
        private readonly P1ProductionValidationService _validation = new();
        ...
        public WorkflowMessage CurrentMessage
        {
            get
            {
                return _context.State switch
                {
                    ...
                    {
                        Title = "SUCCESS",
                        Message = "P1 Production transaction completed successfully.",
