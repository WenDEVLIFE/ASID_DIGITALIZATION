...
{
    public class P2LoadingBayWorkflow : IWorkflow
    {
        private readonly P2LoadingBayContext _context = new();
        public P2LoadingBayContext Context => _context;
        public WorkflowState CurrentState => _context.State;
        private readonly P2LoadingBayValidationService _validation = new();
        ...
        public WorkflowMessage CurrentMessage
        {
            get
            {
                return _context.State switch
                {
                    ...
                    {
                        Title = "SUCCESS",
                        Message = "P2 Loading Bay transaction completed successfully.",
