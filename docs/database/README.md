...
2. **Schema Reference**: Check [transactions-table.md](file:///e:/desktop_gui_projects/ASID/docs/database/schemas/transactions-table.md) and [daily-demand-table.md](file:///e:/desktop_gui_projects/ASID/docs/database/schemas/daily-demand-table.md) for full DDL and column descriptions.
