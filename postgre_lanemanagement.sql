...
-- Stores lane configuration, occupancy, and status for all 100 lanes (A-01 to A-50, B-01 to B-50)
...
-- Seed sample data for testing (matches the design spec image)
-- Only seed if table is empty
INSERT INTO lane_management (lane_no, part_no, max_qty_stored, actual_stored_qty, withdrawn_qty, lane_status, color_status)
SELECT * FROM (VALUES
...
) AS v(lane_no, part_no, max_qty_stored, actual_stored_qty, withdrawn_qty, lane_status, color_status)
WHERE NOT EXISTS (SELECT 1 FROM lane_management LIMIT 1);
